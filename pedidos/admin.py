...
admin.site.site_header = "Admin Cafeteria Saku"
admin.site.site_title = "Panel Cafeteria Saku"
...
class ProductoAdmin(admin.ModelAdmin):
    ...
    # Aquí Esta pendiente enlazarlo con la plantilla de HTML para la lista 
